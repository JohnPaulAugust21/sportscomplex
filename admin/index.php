...
<html lang="">
	...
	<body>
		...
		<?php 
				...
				if(isset($_GET['delid']))
					{
						...
						$res = $db->deleteRow($sql,[$venueID]);

						$venueImage = $_GET['venueImage'];
						if($venueImage != '../boat_image/'.'default.png'){
							unlink($venueImage);
						}
		 ...
		 <div class="container">
			<a href="venue_create.php" class="btn btn-success">
				Add Venue
				...
				<tbody>
					<?php 
						...
						foreach ($res as $row) {
							...
							$venueRentalFee = $row['venueRentalFee'];
						

					?>
					<tr>
						<td class="align-img"><?php echo $venueName; ?></td>
						<td class="align-img"><?php echo $venueType; ?></td>
						...
						<td class="align-img">
							<a class = "btn btn-success btn-xs" href="edit_food_items.php?editid=<?php echo $venueID; ?>">
								Edit
								<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
							</a>
							<a class = "btn btn-danger  btn-xs" href="index.php?delid=<?php echo $venueID; ?>&venueImage=<?php echo $venueImage; ?>">
								Delete
