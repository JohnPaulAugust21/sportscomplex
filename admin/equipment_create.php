			...
			<br />
					...
					if(isset($_POST['newboat']))
						{
							...
							$sql = "INSERT INTO equipments (equipmentName, equipmentType, equipmentRentalFee, equipmentImage)
									VALUES(?,?,?,?);
								";
							...
							if(!$equipmentName){
								echo '
										<div class="alert alert-danger">
										  ...
										  <strong>Equipment name is required.</strong> 
										</div>
									';
							}else if(!$equipmentRentalFee){
								echo '
										<div class="alert alert-danger">
										  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
										  <strong>Equipment type is required.</strong> 
										</div>
									';
							}else{
								...
								move_uploaded_file($_FILES["equipmentImage"]["tmp_name"], "../venueImage/".$new_image_name);
								$new_image_name = '../venueImage/'.$new_image_name;
								//echo $new_image_name;

								if(empty($_FILES["equipmentImage"]["tmp_name"])){
									$new_image_name = '../venueImage/'.'default.png'; 
								}

								$res = $db->insertRow($sql, [$equipmentName,$equipmentType,$equipmentRentalFee, $new_image_name]);
								if($res)
								{
									echo '
				...
				<form action = "" method = "POST" enctype="multipart/form-data">
					   ...
					   <div class="form-group">
					    ...
					    <input class="form-control" id="inputdefault"  name="equipmentName" type="text">
					  </div>

					  <div class="form-group">
					    <label for="inputdefault">Equipment Type:</label>
					    <input class="form-control" id="inputdefault" name="equipmentType" type="text">
					  </div>

					  <div class="form-group">
					    <label for="inputdefault">Equipment Rental Fee:</label>
					    <input class="form-control" id="inputdefault" name="equipmentRentalFee" type="text">
					  </div>

					    <div class="form-group">
				    	  <label for="inputdefault">Equipment Image:</label>
					      <input class="form-control" id="inputdefault" name="equipmentImage" type="file">
					    </div>
