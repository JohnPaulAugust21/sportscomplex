...
<!-- begin content -->
	<div class="container-fluid">
		...
		<div class="panel panel-info">
		  <div class="panel-heading"><strong>Equipments Available</strong> (To view the details, click on the image.)</div>
		  			...
		  			$sql = 'SELECT * FROM equipments ORDER by equipmentName';
		  		 	...
		  		 	if($res){
		  		 		foreach ($res as $r) {
	  		 				...
	  		 				$equipmentRentalFee = $r['equipmentRentalFee'];
							  // $reservationFee = $r['reservationFee'];

	  		 	?>	
	  		 		<a href="#"  data-toggle="modal" data-target="#myModal<?php echo $equipmentID; ?>">
						<img class="img-rounded" src="<?php echo $equipmentImage; ?>" height="210" width="305">
	  		 		</a>
 					<!-- Modal -->
						<div id="myModal<?php echo $equipmentID; ?>" class="modal fade" role="dialog">
						  <div class="modal-dialog">
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						      		<div class="row">
						      			<div class="col-md-6">
						      				<img src="<?php echo $equipmentImage; ?>" height="250" width="250">
						      			</div>
						      			<div class="col-md-6">
						      				<form>
						      					<strong>Equipment Name: </strong><?php echo $equipmentName; ?><br /><br>
							      				<strong>Equipment Type: </strong><?php echo $equipmentType; ?><br /><br>
												
							      				<strong>Rental Fee: </strong><?php echo 'Php '.number_format($equipmentRentalFee, 2); ?><br /><br>
												  <!-- <strong>Reservation Fee: </strong><?php echo 'Php 500.00'; ?><br /><br> -->
							      				<!-- <strong>Operator Name: </strong><?php 
							      				//echo $bON; ?> <br />
							      				<strong>Destination: </strong> <br /> -->
							      			<!-- 	<input type = "text" id="dstntn<?php echo $equipmentID; ?>" >
							      				<br /> -->
										   		<strong>Date: </strong>&nbsp;
							      				<br /> 
										    	<input class="btn-default" id="rdate<?php echo $equipmentID; ?>" size="30" name="rdate" type="date" autocomplete="off">
										    	<br /><br>
										    	<strong>Time: </strong>
										    	<br />
						      ...
						      <div class="modal-footer">
						        ...
						        <input type="submit" value="Rent" onclick="bogkot('<?php echo $equipmentID; ?>')" class="btn btn-success" data-dismiss="modal">
						      </div>
						    </div>
