...
<!-- begin content -->
    ...
    <div class="panel panel-info">
		  <div class="panel-heading"><strong>Report</strong></div>
                      ...
                      WHERE m.memberID = ? ';
		  		 	...
		  		 	if($res){
		  		 		foreach ($res as $r) {
							...
							$reservationBilling = $r['reservationFee'] + $r['venueRentalFee'];
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						      		<div class="row">
						      			...
						      			<div class="col-md-6">
						      				<form>
						      					<strong>Venue Name: </strong><?php echo $venueName; ?><br />
							      				<strong>Venue Type: </strong><?php echo $venueType; ?><br />
							      				<strong>Rental Fee: </strong><?php echo 'Php '.number_format($venueRentalFee, 2); ?><br />
							      			...
							      			<!-- 	<input type = "text" id="dstntn<?php echo $venueID; ?>" >
												...
												<strong>Reservation Fee: </strong><?php echo 'Php '.number_format($reservationFee, 2); ?><br />
												<br>
												<br>
												<br>
												<br>
												<strong>Total: </strong><?php echo 'Php '.number_format($reservationBilling, 2); ?><br />
